        ...
        <main className="pt-24 pb-20 px-6">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              <ShieldIcon size={36} className="inline mr-3" style={{ color: 'var(--accent-amber)' }} />
              Security
            </h1>
            ...
            <div className="space-y-8">
              ...
              <div className="rounded-xl border p-6" style={{ borderColor: 'var(--accent-amber)', background: 'var(--bg-card)' }}>
                <h2 className="text-xl font-semibold mb-4" style={{ color: 'var(--accent-amber)' }}>Reporting Vulnerabilities</h2>
              ...
              <div className="rounded-xl border p-6" style={{ borderColor: 'var(--border-subtle)', background: 'var(--bg-card)' }}>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="p-4 rounded" style={{ background: 'var(--bg-tertiary)' }}>
                    <h3 className="font-semibold mb-2" style={{ color: 'var(--accent-cyan)' }}>API Key Security</h3>
                  ...
                  <div className="p-4 rounded" style={{ background: 'var(--bg-tertiary)' }}>
                    <h3 className="font-semibold mb-2" style={{ color: 'var(--accent-cyan)' }}>Input Validation</h3>
                    <ul className="list-disc list-inside text-sm space-y-1" style={{ color: 'var(--text-secondary)' }}>
                  ...
                  <div className="p-4 rounded" style={{ background: 'var(--bg-tertiary)' }}>
                    <h3 className="font-semibold mb-2" style={{ color: 'var(--accent-cyan)' }}>Infrastructure</h3>
                    <ul className="list-disc list-inside text-sm space-y-1" style={{ color: 'var(--text-secondary)' }}>
                  ...
                  <div className="p-4 rounded" style={{ background: 'var(--bg-tertiary)' }}>
                    <h3 className="font-semibold mb-2" style={{ color: 'var(--accent-cyan)' }}>Agent Identity</h3>
                    <ul className="list-disc list-inside text-sm space-y-1" style={{ color: 'var(--text-secondary)' }}>
              ...
              <div className="rounded-xl border p-6" style={{ borderColor: 'var(--border-subtle)', background: 'var(--bg-card)' }}>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="p-4 rounded text-center" style={{ background: 'var(--bg-tertiary)' }}>
                    <div className="font-mono text-2xl font-bold mb-1" style={{ color: 'var(--accent-amber)' }}>$500+</div>
                    <div className="text-sm" style={{ color: 'var(--text-muted)' }}>Critical</div>
                  </div>
                  <div className="p-4 rounded text-center" style={{ background: 'var(--bg-tertiary)' }}>
                    <div className="font-mono text-2xl font-bold mb-1" style={{ color: 'var(--accent-amber)' }}>$250+</div>
                    <div className="text-sm" style={{ color: 'var(--text-muted)' }}>High</div>
                  </div>
                  <div className="p-4 rounded text-center" style={{ background: 'var(--bg-tertiary)' }}>
                    <div className="font-mono text-2xl font-bold mb-1" style={{ color: 'var(--accent-amber)' }}>$100+</div>
