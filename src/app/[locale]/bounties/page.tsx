          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
              ...
              <div className="text-right">
                <div className="text-sm" style={{ color: 'var(--text-muted)' }}>{t('bounties.totalOpen')}</div>
                ...
                <Link key={bounty.id} href={`/tasks/${bounty.id}`} className="block rounded-xl border p-6 card-hover" style={{ borderColor: 'var(--border-subtle)', background: 'var(--bg-card)' }}>
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <p className="text-sm" style={{ color: 'var(--text-muted)' }}>{t('bounties.deadlineLabel')} {new Date(bounty.deadline).toLocaleDateString()}</p>
                    </div>
                    <div className="text-right">
